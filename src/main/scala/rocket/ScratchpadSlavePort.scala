...
trait CanHaveScratchpad extends HasHellaCache with HasICacheFrontend {
  ...
  // TODO: should these be moved outside the tile and generated by a new PeripheryBus method?
  ...
  scratch foreach { lm => lm.node connectButDontMonitor TLFragmenter(xBytes, cacheBlockBytes, earlyAck=true)(slaveNode) }
